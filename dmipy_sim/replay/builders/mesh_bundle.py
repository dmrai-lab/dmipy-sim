...
A packed bundle is three compartments, and unlike an isolated axon (:mod:`dmipy_sim.replay.builders.mesh_axon`) all three
...
def mesh_bundle_master(bundle, *, n_walkers=30_000, params=None, T_max=0.04, dt_save=None, n_t=80,
    ...
    **Uniform density.** ``n_walkers`` is the TOTAL spin count, seeded at uniform density through the box:
    ...
    def _walk(n, D, geom, sd, r0):
        ...
        o = simulate_trajectories(n, D, geom, T_max=T_max, dt_save=dt_save, seed=sd, r0=r0, require_gpu=require_gpu,
