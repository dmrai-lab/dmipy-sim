...
from .susceptibility import SusceptibilitySources, refocus_sign
...
__all__ = [
    ...
    "PermeableSlab1D",
    "Mesh", "load_ply",
    "SusceptibilitySources", "refocus_sign", "plot_susceptibility_sources",
    "GAMMA",
